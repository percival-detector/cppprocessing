...
if ( NOT TBB_ROOT )
    ...
    find_path( TBB_INCLUDE_DIRS 
        NAMES tbb/tbb.h ${PC_TBB_INCLUDEDIR} ${PC_TBB_INCLUDE_DIRS}
    ...
    find_library(TBB_LIBRARY ${_TBB_LIB_NAME} HINTS ${_TBB_LIBRARY_DIR}/${TBB_COMPILER} ${TBB_ROOT}/lib ${PC_TBB_LIBDIR} ${PC_TBB_LIBRARY_DIRS}
                PATHS ENV LIBRARY_PATH ENV LD_LIBRARY_PATH)
    find_library(TBB_MALLOC_LIBRARY ${_TBB_LIB_MALLOC_NAME} HINTS ${_TBB_LIBRARY_DIR}/${TBB_COMPILER} ${TBB_ROOT}/lib ${PC_TBB_LIBDIR} ${PC_TBB_LIBRARY_DIRS}
                PATHS ENV LIBRARY_PATH ENV LD_LIBRARY_PATH)
    find_library(TBB_LIBRARY_DEBUG ${_TBB_LIB_DEBUG_NAME} HINTS ${_TBB_LIBRARY_DIR}/${TBB_COMPILER} ${TBB_ROOT}/lib ${PC_TBB_LIBDIR} ${PC_TBB_LIBRARY_DIRS}
                PATHS ENV LIBRARY_PATH ENV LD_LIBRARY_PATH)
    find_library(TBB_MALLOC_LIBRARY_DEBUG ${_TBB_LIB_MALLOC_DEBUG_NAME} HINTS ${_TBB_LIBRARY_DIR}/${TBB_COMPILER} ${TBB_ROOT}/lib ${PC_TBB_LIBDIR} ${PC_TBB_LIBRARY_DIRS}
                PATHS ENV LIBRARY_PATH ENV LD_LIBRARY_PATH)        
    ...
    FIND_PACKAGE_HANDLE_STANDARD_ARGS( TBB DEFAULT_MSG TBB_LIBRARY TBB_INCLUDE_DIRS TBB_ROOT)
