...
//COMPUTATION TESTS
	BOOST_AUTO_TEST_CASE (try_correct_values){
			...
			float ADU_2e_conv = 7.1;
//
			*(calib_params.Gain_lookup_table1.data + 5) = G1;
			*(calib_params.Gain_lookup_table2.data + 5) = G2;
			*(calib_params.Gain_lookup_table3.data + 5) = G3;
			*(calib_params.Gain_lookup_table4.data + 5) = G4;
			*(calib_params.Gc.data + 5) = Gc;
			*(calib_params.Gf.data + 5) = Gf;
			*(calib_params.Oc.data + 5) = Oc;
			*(calib_params.Of.data + 5) = Of;
//
			*(src_frame.data + 5) = 0b0111110111110101; //0b011111 01111101 01;
			...
			BOOST_REQUIRE_CLOSE(correct_result, *(output_frame.data + 5), 0.01);
		}
