...
BOOST_FIXTURE_TEST_SUITE (percival_algorithm_avx_pf_test,fixture_ADC_decode_combined_pipeline)
...
//RANGE TESTS
	...
	BOOST_AUTO_TEST_CASE ( should_throw_exception_if_grain_size_exceed_no_of_element_or_below_zero ){
		BOOST_REQUIRE_NO_THROW(percival_algorithm_avx_pf(sample_frame,reset_frame,output_frame, calib_params_avx, TEST_FRAME_WIDTH * TEST_FRAME_HEIGHT + 1));
		BOOST_REQUIRE_NO_THROW(percival_algorithm_avx_pf(sample_frame,reset_frame,output_frame, calib_params_avx, -10));
		BOOST_REQUIRE_NO_THROW(percival_algorithm_avx_pf(sample_frame,reset_frame,output_frame, calib_params_avx, 0));
	}
